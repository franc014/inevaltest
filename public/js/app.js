...
var studentForm = vue.extend({
    ...
    methods: {
        hideStudentsForm: function hideStudentsForm(event) {
            this.student = {};
            this.errors = {};
            this.enableForm = false;
            this.$dispatch('hide-add-button');
        },
        saveStudent: function saveStudent(event) {
    ...
    events: {
        'enable-form': function enableForm() {
            this.enableForm = true;
        },
        'edit-student': function editStudent(student) {
            this.enableForm = true;
...
var studentsGrid = vue.extend({
    ...
    methods: {
        showStudentsForm: function showStudentsForm() {
    ...
    events: {
        'hide-add-button': function hideAddButton() {
            this.isAddButtonEnabled = true;
            this.fetchStudentsList();
        },
        'student-added': function studentAdded(student) {
            this.students.push(student);
            this.fetchStudentsList();
        },
        'student-edited': function studentEdited() {
            this.fetchStudentsList();
        }
    }
});

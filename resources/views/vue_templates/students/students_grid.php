        ...
        <div class="col-sm-12">
            <table class="table table-condensed" v-if="students.length != 0" >
                ...
                <tr v-for="student in students"  transition="expand" track-by="$index">
                    ...
                    <td><a href="#" class="glyphicon glyphicon-pencil" v-on:click="editStudent(student)"> Editar</a></td>
                    <td><a href="#" class="glyphicon glyphicon-trash" v-on:click="deleteStudent(student)"> Eliminar</a></td>
                </tr>
